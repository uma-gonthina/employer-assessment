<template>
  <div class="block w-[800px] p-4 bg-white border border-gray-200 rounded-lg shadow bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:bg-gray-700 mt-2">
                        ...
                        <div class="px-4 sm:px-6">
                          <div>
                            <DialogTitle
                              ...
                              >Employer-Assessment</DialogTitle
                            >
                            <div>
...
const { data: formdata } = await useAuthLazyFetch(
  `https://v7-stark-db-orm.mercury.infinity-api.net/api/assessments/?offset=0&limit=100&sort_column=id&sort_direction=des`,{});
...
// Get forms
  ...
  form.value=[]
  const { data: formdata } = await useAuthLazyFetch( `https://v7-stark-db-orm.mercury.infinity-api.net/api/assessments/?offset=0&limit=100&sort_column=id&sort_direction=des`, {});
  form.value = formdata.value;
};
